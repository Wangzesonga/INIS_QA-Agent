...
- **`auto_correction_processor.py`**: Automatic correction processing (creates corrected record files)
- **`auto_correction_applier.py`**: Applies corrections directly to INIS production system
...
The system can now apply corrections directly to INIS production system. This includes:
...
3. Use the standalone correction applier:
   ```bash
   # Dry-run mode
